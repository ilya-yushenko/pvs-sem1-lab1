...
#define MIN_FREQUENCY 0.1         // Минимальная частота (0.1 Гц)
#define MAX_FREQUENCY 9.9         // Максимальная частота (9.9 Гц)
#define RX_BUFFER_SIZE 16         // Размер буфера приема UART
